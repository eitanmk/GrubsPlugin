...
public class TeleportModule implements CommandExecutor, IGrubsModule {
	...
	private void saveTeleportPresets() {
		...
		log.info(logPrefix + "Writing Teleport presets file.");
		try {
			...
			log.info(logPrefix + "Error writing Teleport presets file!");
			ex.printStackTrace();
		}
	}
